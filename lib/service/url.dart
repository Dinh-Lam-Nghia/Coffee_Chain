class Url {
  static const String baseUrl = "http://192.168.1.6/serverAPI_CoffeeChain";
  ...
  static const String getTablePhieuTC = "$baseUrl/getPhieuThuChi.php";
  static const String getPhieuNhapKho = "$baseUrl/getPhieuNhapKho.php";
  static const String getPhieuThu = "$baseUrl/getPhieuThu.php";
  static const String getPhieuChi = "$baseUrl/getPhieuChi.php";
  ...
  static const String addHoaDon = "$baseUrl/addHoaDon.php";
  static const String adddSMonHoaDon = "$baseUrl/adddSMonHoaDon.php";
  ...
  static const String deleteBanHD = "$baseUrl/deleteBanHD.php";
